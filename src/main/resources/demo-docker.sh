...
docker pull blackducksoftware/hub-imageinspector-ws-alpine:0.2.1-SNAPSHOT
docker pull blackducksoftware/hub-imageinspector-ws-centos:0.2.1-SNAPSHOT
docker pull blackducksoftware/hub-imageinspector-ws-ubuntu:0.2.1-SNAPSHOT
...
docker run -v /tmp/imageinspector:/opt/blackduck/hub-imageinspector-ws/target -d --name hub-imageinspector-ws-alpine -p 8080:8080 blackducksoftware/hub-imageinspector-ws-alpine:0.2.1-SNAPSHOT
docker run -v /tmp/imageinspector:/opt/blackduck/hub-imageinspector-ws/target -d --name hub-imageinspector-ws-centos -p 8081:8081 blackducksoftware/hub-imageinspector-ws-centos:0.2.1-SNAPSHOT
docker run -v /tmp/imageinspector:/opt/blackduck/hub-imageinspector-ws/target -d --name hub-imageinspector-ws-ubuntu -p 8082:8082 blackducksoftware/hub-imageinspector-ws-ubuntu:0.2.1-SNAPSHOT
